...
const AnimalKind = ({ selectedType, selectedKind, handleSelectedKindChange, setNextPossible }) => {
    ...
    const handleEditClick = () => {
        ...
        setTimeout(() => {
            if (inputRef.current) {
                ...
                inputRef.current.setSelectionRange(localSelectedKind.length, localSelectedKind.length);
    ...
    return (
        <div className={styles.container}>
            ...
            {isKindSelected ? (
                <div className={styles.selected_searchbar_wrapper} onClick={handleEditClick}>
