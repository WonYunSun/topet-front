  ...
  return (
    ...
    <div className={`${styles.wrapper} ${styles.mbver} `}>
      <div className={styles.logo_wrapper}>
        <div className={`${styles.subtitle} ${styles.mbver}`}>반려동물 라이프스타일 매니저</div>
    ...
    <DeskTop>
      <div className={`${styles.wrapper} ${styles.dtver} `}>
        ...
        <div className={styles.rightside_wrapper}>
          ...
          <div className={`${styles.subtitle} ${styles.dtver}`}>반려동물 라이프스타일 매니저</div>
        </div>
          <div className={styles.login_wrapper}>
            {/* <div className={styles.background_circle}></div> */}
            <div className={styles.usesns_text}>sns계정으로 투펫을 이용해 보세요</div>
            <div className={styles.divider}></div>
            <div className={`${styles.kakao_button_wrapper} ${styles.dtver}`}>
              <KakaoLoginBtn
      ...
      <div className={styles.privacy_notice_text}>
        시작과 동시에 투펫의 <span className={styles.privacy_notice_text_bold}> 서비스 약관, 개인정보 취급방침</span>에 동의하게 됩니다.
      </div>
    </div>
    </DeskTop>
    </>
